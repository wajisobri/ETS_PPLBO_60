...
import com.programming.techie.cafeservice.service.CafeService;
...
public class CafeController {
    ...
    @GetMapping(value="/cafe/ingredient/{cafeId}/{ingredientId}")
    @ResponseStatus(HttpStatus.OK)
    public IngredientResponse getIngredient(@PathVariable String cafeId, @PathVariable String ingredientId) {
        return cafeService.getIngredient(cafeId, ingredientId);
    }
