package com.programming.techie.cafeservice.service;

import com.programming.techie.cafeservice.dto.*;
import com.programming.techie.cafeservice.model.Cafe;
import com.programming.techie.cafeservice.model.Ingredient;
import com.programming.techie.cafeservice.repository.CafeRepository;
import com.programming.techie.cafeservice.repository.IngredientRepository;
...
public class CafeService {
    ...
    public IngredientResponse getIngredient(String cafeId, String ingredientName) {
        try {
            Optional<Ingredient> ingredient = ingredientRepository.findByCafeIdAndName(cafeId, ingredientName);
            ...
            return IngredientResponse.builder()
                    .code(200)
                    .message("Ingredient with name " + ingredientName + " in cafe with id " + cafeId + " found")
