...
public class RabbitMQConfig {
    ...
    @Bean
    public Binding orderNotificationBinding(Queue orderQueue, DirectExchange orderExchange) {
        return BindingBuilder.bind(orderQueue).to(orderExchange).with(NOTIFICATION_ROUTING_KEY);
    }
    @Bean
